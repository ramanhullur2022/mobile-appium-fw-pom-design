...
public class Page_SendReceive_SendAttachment_TC001 extends Base_Class {

	public Page_SendReceive_SendAttachment_TC001(WebDriver driver) {
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='Vedlegg']")
	@CacheLookup
	public WebElement clk_Vedlegg;

	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='Legg til vedlegg']")
	@CacheLookup
	public WebElement clk_Legg_til_vedlegg;
	
	@FindBy(xpath = "//android.widget.TextView[@content-desc='Search']")
	@CacheLookup
	public WebElement clk_search_button;
	
	@FindBy(xpath = "//android.widget.TextView[@content-desc='Search']")
	@CacheLookup
	public WebElement clk_search_button_2;
	
	@FindBy(id = "android:id/search_src_text")
	@CacheLookup
	public WebElement input_search_edit_text;
	
	
	@FindBy(xpath = "//android.widget.LinearLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ImageView[2]")
	@CacheLookup
	public WebElement clk_and_select_file;
	
	@FindBy(xpath = "(//android.widget.ImageView)[3]")
	@CacheLookup
	public WebElement clk_and_select_Img_file;
	
	
	@FindBy(xpath = "//android.widget.ImageView[@content-desc='Clear query']")
	@CacheLookup
	public WebElement clk_open_attach;
	

	@FindBy(xpath = "//android.view.ViewGroup[2]/android.view.ViewGroup/android.widget.TextView")
	@CacheLookup
	public WebElement clk_remove_attachment;
	
	
	@FindBy(xpath = "//android.widget.Switch[@content-desc='Få meldinger på e-post']")
	@CacheLookup
	public WebElement clk_FaMelding_Toggle;
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='addContactText']")
	@CacheLookup
	public WebElement Add_Contacts_OK;
	...
	@FindBy(xpath="//android.view.ViewGroup[@content-desc='Lukket']")
	@CacheLookup
	public WebElement Close_Mail_new;
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='Vedlegg']/android.view.ViewGroup/android.widget.TextView")
	@CacheLookup
	public WebElement clickOnReceivedAttachment;
	
	@FindBy(xpath = "//android.widget.ImageButton[@content-desc='Navigate up']")
	@CacheLookup
	public WebElement clickOnNavigateBack;
	...
	/**
	 * Click on attachement and open the attached file then closing
	 * @throws InterruptedException
	 */
	public void clickOnAttachmentInMessageAndOpen() throws InterruptedException {
		boolean is_CloseMail_Displayed = Base_Class.is_Element_Present(driver2, Close_Mail, 40);
		if(is_CloseMail_Displayed == true) {
			if(clickOnReceivedAttachment.isDisplayed()) {
				clickOnReceivedAttachment.click();
			}
			Thread.sleep(5000);
		}
	}
	...
	/**
	 * Closing pdf attachment file
	 * @throws InterruptedException
	 */
	public void closeTheAttachmentFile() throws InterruptedException {
		Thread.sleep(4000);
		clickOnNavigateBack.click();
		Thread.sleep(3000);
	}
	
	/**
	 * Click on search and search the file
	 * @throws InterruptedException
	 */
	public void searchAttachmentAndSelect() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, clk_search_button, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_search_button.click();
			Thread.sleep(2000);
			input_search_edit_text.sendKeys("dummy");
			Thread.sleep(1000);
			AndroidDriver dr_enter=(AndroidDriver) driver2;
			dr_enter.pressKeyCode(AndroidKeyCode.ENTER);
			Thread.sleep(2000);
	...
	public void searchAddAttachmentAgain() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, clk_search_button_2, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_search_button_2.click();
			Thread.sleep(2000);
			input_search_edit_text.sendKeys("dummy2");
			Thread.sleep(1000);
			AndroidDriver dr_enter=(AndroidDriver) driver2;
			dr_enter.pressKeyCode(AndroidKeyCode.ENTER);
			Thread.sleep(2000);
	...
	public void searchAddSecondAttachment() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, clk_search_button_2, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_search_button_2.click();
			Thread.sleep(2000);
			input_search_edit_text.sendKeys("norway");
			Thread.sleep(1000);
			AndroidDriver dr_enter=(AndroidDriver) driver2;
			dr_enter.pressKeyCode(AndroidKeyCode.ENTER);
			Thread.sleep(2000);
	...
	/**
	 * Click on search result file to attach
	 * @throws InterruptedException
	 */
	public void clickOnFileAndAttach() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, clk_and_select_file, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_and_select_file.click();
			Thread.sleep(2000);
			clk_open_attach.click();
			Thread.sleep(2000);
	 ...
	 * @throws InterruptedException
	 */
	public void clickOnFileAndAttachAagin() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, clk_and_select_file, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_and_select_file.click();
			Thread.sleep(2000);
	 ...
	 * @throws InterruptedException
	 */
	public void clickOnImageFileAndAttachAagin() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, clk_and_select_Img_file, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_and_select_Img_file.click();
			Thread.sleep(2000);
			clk_open_attach.click();
			Thread.sleep(2000);
			Add_Contacts_OK.click();
	 ...
	 * @throws InterruptedException
	 */
	public void clickAndRemoveAttchement() throws InterruptedException {
		boolean is_CloseMail_Displayed = Base_Class.is_Element_Present(driver2, Close_Mail, 40);
		if(is_CloseMail_Displayed == true) {
			clk_remove_attachment.click();
			Thread.sleep(2000);
	...
	/**
	 * Go to settings and click on enable toggle button then click on logout
	 * @throws InterruptedException
	 */
	public void addAnAttachmentWithMessage() throws InterruptedException {
		boolean is_SettingsTab_Displayed = Base_Class.is_Element_Present(driver2, Close_Mail, 40);
		if(is_SettingsTab_Displayed == true) {
			clk_Vedlegg.click();
			Thread.sleep(2000);
			clk_Legg_til_vedlegg.click();
	 ...
	 * @throws InterruptedException
	 */
	public void clickOnSvarAvToggle() throws InterruptedException {
