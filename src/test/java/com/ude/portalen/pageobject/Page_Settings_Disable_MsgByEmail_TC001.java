...
public class Page_Settings_Disable_MsgByEmail_TC001 extends Base_Class {

	public Page_Settings_Disable_MsgByEmail_TC001(WebDriver driver) {
	...
	/**
	 * Go to settings and click disable/enable toggle button
