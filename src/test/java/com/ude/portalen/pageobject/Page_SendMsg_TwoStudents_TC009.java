...
public class Page_SendMsg_TwoStudents_TC009 extends Base_Class {
	
	ReadConfig config = new ReadConfig();

	public Page_SendMsg_TwoStudents_TC009(WebDriver driver) {
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='ludra001']")
	@CacheLookup
	public WebElement clk_Search_ludra001;
	
	
	
	public void click_Search_Input_editText_testcase3() throws InterruptedException {
		//Remove static test data once search issue issue is fixed
		//clk_Search_Input.sendKeys(config.get_student_username_oneSchool());
		clk_Search_Input.sendKeys("Ludvig Draget");
		Thread.sleep(15000);
	}
	
	
	public void click_Search_Result_Student2() throws InterruptedException {
		boolean is_tttta_Displayed = Base_Class.is_Element_Present(driver2, clk_Search_ludra001, 10);
		if (is_tttta_Displayed == true) {
			clk_Search_ludra001.click();
		}
		Thread.sleep(1000);
		clk_Search_ludra001.click();
		Thread.sleep(8000);
	...
	public String getExpectedResult(String val) throws InterruptedException {
		boolean is_Text_Displayed = Base_Class.is_Element_Present(driver2, Close_Mail, 40);
