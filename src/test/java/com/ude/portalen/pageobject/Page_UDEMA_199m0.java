...
public class Page_UDEMA_199m0 extends Base_Class {

	public Page_UDEMA_199m0(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}

	DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm");
	LocalDateTime now = LocalDateTime.now();
	public String Msg_Body = "TeacherToStudent" + dtf.format(now);
	public String Msg_Title = "TeacherToStudent" + dtf.format(now);
	public String Reply_Text = "ReplyFromStudent" + dtf.format(now);
	...
	@CacheLookup
	public WebElement clk_reply_allowed;
	...
	@FindBy(xpath = "//android.widget.TextView[@text='Spørsmål']")
	@CacheLookup
	public WebElement Click_Reply_Send;
	
	@FindBy(xpath = "//android.widget.EditText[@content-desc='Skriv svar her. Dobbeltklikk for å skrive svar']")
	@CacheLookup
	public WebElement Send_Reply_Text;
	...
	public void click_Mail_Compose() throws InterruptedException {
	...
	public void click_Till_Button() throws InterruptedException {
		Clk_Till.click();
		Thread.sleep(2000);

	}

	public void click_School_Drop_Down() throws InterruptedException {
		clk_Velg_Skole.click();
		Thread.sleep(2000);

	}

	public void click_School_Drop_Down_Options() throws InterruptedException {
	...
	public void click_Personer_Tab() throws InterruptedException {
	...
	public void click_Search_Input_editText() throws InterruptedException {
		clk_Search_Input.sendKeys("Alexander");
		Thread.sleep(15000);
...
//			Thread.sleep(2000);
	...
	public void click_Close_mail() throws InterruptedException {
		Close_Mail.click();
		Thread.sleep(10000);
	}
	

	public void Send_Reply_Text() {
		Send_Reply_Text.click();
		Send_Reply_Text.sendKeys(Reply_Text);
