...
public class Page_SendMsg_TwoTeacher_TC001 extends Base_Class {

	public Page_SendMsg_TwoTeacher_TC001(WebDriver driver) {
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='masya010']/android.view.ViewGroup")
	@CacheLookup
	public WebElement clk_Search_TeacherTwo;
	
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='stcga001']/android.view.ViewGroup")
	@CacheLookup
	public WebElement clk_Search_TeacherStcga;

	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='Eleven + Foresatte']")
	@CacheLookup
	public WebElement clk_Checkbox;
	
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='Eleven']")
	@CacheLookup
	public WebElement clk_Checkbox_Eleven;
	
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc='Foresatte']")
	@CacheLookup
	public WebElement clk_Checkbox_Foresatte;
	 ...
	 * @throws InterruptedException
	 */
	public void clickOnSearchInputEditTextForTeacher() throws InterruptedException {
		clk_Search_Input.sendKeys("masya010");
		Thread.sleep(15000);
	}
	...
	/**
	 * Select Teacher from list and click to select
	 * @throws InterruptedException
	 */
	public void clickOnSearchResultOfTeacher() throws InterruptedException {
		boolean is_Alela_Displayed = Base_Class.is_Element_Present(driver2, clk_Search_TeacherTwo, 10);
		if(is_Alela_Displayed == true) {
			clk_Search_TeacherTwo.click();
			Thread.sleep(500);
			clk_Search_TeacherTwo.click();
			Thread.sleep(8000);
			//clk_Checkbox.click();
	 ...
	 * @throws InterruptedException
	 */
	public void clickOnSearchResultOfStudentOnlyForesatte() throws InterruptedException {
		boolean is_Alela_Displayed = Base_Class.is_Element_Present(driver2, clk_Search_Alana041, 10);
		if(is_Alela_Displayed == true) {
			clk_Search_Alana041.click();
			Thread.sleep(500);
	 ...
	 * @throws InterruptedException
	 */
	public void clickOnArkivFat() throws InterruptedException {
		boolean is_Filter_Displayed = Base_Class.is_Element_Present(driver, Filter_Button, 40);
		if(is_Filter_Displayed == true) {
			Arkiv_Sent.click();
			Thread.sleep(2000);
	 ...
	 * @throws InterruptedException 
	 */
	public String getExpectedResultFat(String val) throws InterruptedException {
		boolean is_Text_Displayed = Base_Class.is_Element_Present(driver, Close_Mail, 30);
		if(is_Text_Displayed == true) {
			val = get_Expected_Text_TC6.getText();
			Close_Mail.click();
			Thread.sleep(2000);
	 ...
	 * @throws InterruptedException 
	 */
	public String getExpectedResultForTC2(String val) throws InterruptedException {
		boolean is_Text_Displayed = Base_Class.is_Element_Present(driver2, Close_Mail, 30);
		if(is_Text_Displayed == true) {
			val = get_Mail_Title_Text.getText();
			System.out.println(val);
