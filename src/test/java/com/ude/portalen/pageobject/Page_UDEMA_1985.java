...
public class Page_UDEMA_1985 extends Base_Class {

	public Page_UDEMA_1985(WebDriver driver) {
	...
	/**
	 * Gets Message Title Text From Received Message
	...
	public void codeEntryForsatte() throws InterruptedException {
		Thread.sleep(8000);
