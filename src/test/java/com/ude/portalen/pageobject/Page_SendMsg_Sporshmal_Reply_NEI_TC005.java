...
public class Page_SendMsg_Sporshmal_Reply_NEI_TC005 extends Base_Class {

	public Page_SendMsg_Sporshmal_Reply_NEI_TC005(WebDriver driver) {
	...
	@FindBy(xpath = "//android.widget.TextView[@text='JA']")
	@CacheLookup
	public WebElement click_NEI_Sporshmal;
	
	@FindBy(xpath = "//android.widget.TextView[@text='Send']")
	@CacheLookup
	public WebElement click_Send_NEI;
	
	
	@FindBy(xpath = "(//android.widget.TextView[@text='1'])[1]")
	@CacheLookup
	public WebElement get_NEI_response;
	 ...
	 */
	public String getActualResultNEI(String val) throws InterruptedException {
		Thread.sleep(2000);
		//val = get_Mail_Title_Text.getText();
		val = get_NEI_response.getText();
		System.out.println("Here is the NEI response" + val);
		if(val.equals("1"))
			Close_Mail.click();
			Thread.sleep(3000);
		return val;
	 ...
	 * @throws InterruptedException
	 */
	public String getActualResultJA(String val) throws InterruptedException {
		Thread.sleep(2000);
		//val = get_Mail_Title_Text.getText();
		val = get_NEI_response.getText();
		System.out.println("Here is the NEI response" + val);
	...
	public void clickOnNEIAndSendMsg() throws InterruptedException {
		boolean NEI_isDisplayed = Base_Class.is_Element_Present(driver2, click_NEI_Sporshmal,10);
		if (NEI_isDisplayed == true) {
			click_NEI_Sporshmal.click();
			Thread.sleep(3000);
			click_Send_NEI.click();
			Thread.sleep(2000);
		}
	}
	
	public void clickOnJAAndSendMsg() throws InterruptedException {
		boolean NEI_isDisplayed = Base_Class.is_Element_Present(driver2, click_NEI_Sporshmal,10);
		if (NEI_isDisplayed == true) {
			click_NEI_Sporshmal.click();
			Thread.sleep(3000);
	...
	public void clickSvarAvButton() throws InterruptedException {
		if (Click_Svar_av_toggle.getText().equals("Svar av")) {
			System.out
					.println("Allow Reply is disabled, Enabling it. Current value : " + Click_Svar_av_toggle.getText());
	...
	/**
	 * Navigate to Arkiv Sendt, Searches for a mail, open it and get message body
	 * text
	 * 
	 * @param val
	...
	/**
	 * Navigate to Arkiv Mottatt folder, Search for a mail with msg title and open
	 * it
	 * 
	 * @throws InterruptedException
	 */
