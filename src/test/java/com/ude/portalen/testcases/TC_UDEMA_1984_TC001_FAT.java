...
public class TC_UDEMA_1984_TC001_FAT extends Base_Class{
	...
	@Test
	public void send_Receive_New_Message_with_Svar_Av() throws Exception {
		...
		try {
			...
			test = extent.createTest("UDEMA_1984_TC001_FAT", "Teacher sends message to Student with the option Svar av");
