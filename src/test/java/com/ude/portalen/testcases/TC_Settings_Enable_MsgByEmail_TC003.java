...
public class TC_Settings_Enable_MsgByEmail_TC003 extends Base_Class{
	 ...
	 * Test Case ID  : TC_Settings_Enable_MsgByEmail_TC003
	 * Test Summary  : Receive/Verify message by email option with enable option from the app Innstillinger(Settings)
	...
	public void disableMessageByEmail() throws InterruptedException, Exception {
		String statusLog = "TC_Settings_Enable_MsgByEmail_TC003";
		
		try {

			//start_Server();
			extent = ExtentManager.GetExtent();
			test = extent.createTest("TC_Settings_DisableMsgByEmail_TC003", "Receive/Verify message by email option with Enable option from the app Innstillinger(Settings)");
