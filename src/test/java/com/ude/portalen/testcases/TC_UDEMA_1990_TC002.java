...
public class TC_UDEMA_1990_TC002 extends Base_Class {
	...
	public void send_reply_from_student_to_teacher() throws InterruptedException, Exception {
		...
		try {
			...
			test = extent.createTest("UDEMA_1990_TC002", "Send Reply from Student to Teacher");
			...
			elev_login_teacher.loginAsGeneric("teacher", "test");
...
//			test.log(Status.PASS, "Click on Personer Tab to select student "+config.get_student_username());
//
//			// Search for student
...
//			test.log(Status.PASS, "Clicked on search input box and search for student "+config.get_student_username());
//
...
//			test.log(Status.PASS, "Searched for student "+config.get_student_username()+" and click on Eleven + Foresatte checkbox");
			...
			test.log(Status.PASS, "Teacher "+config.get_teacher_username()+" sent message successfully to student "+config.get_student_username());
			...
			test.log(Status.PASS, "Log in as Student - "+config.get_student_username()+" is successful");
			...
			test.log(Status.PASS, "Sending reply to received message from teacher("+config.get_teacher_username()+" is successful");
			...
			test.log(Status.PASS, "Starting relogin of Teacher("+config.get_teacher_username()+") to verify reply from Student("+config.get_student_username()+")");
			...
			test.log(Status.PASS, "Relogin as Teacher("+config.get_teacher_username()+") to verify reply from Student("+config.get_student_username()+") is successful");
			...
			test.log(Status.PASS, "Opening received message from Student "+config.get_student_username()+" is successful");
			...
			test.log(Status.PASS, "Reply from Student("+config.get_student_username()+") is received by Teacher("+config.get_teacher_username()+") and it is verified");
