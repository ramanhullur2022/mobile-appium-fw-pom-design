...
public class TC_SendMsg_Svar_Pa_Sporsmal_TC004 extends Base_Class{
	 ...
	 * Test Case ID  : TC_SendMsg_Svar_Pa_Sporsmal_TC004
	 * Test Summary  : Send new message from Teacher to the Student with the Spørsmål enabled and Svar pa optioned is enabled
	...
	public void send_Receive_New_Message_with_Spørsmål() throws InterruptedException, Exception {
		...
		String statusLog = "TC_SendMsg_Svar_Pa_Sporsmal_TC004";
		try {

			//start_Server();
			extent = ExtentManager.GetExtent();
			test = extent.createTest("TC_SendMsg_Svar_Pa_Sporsmal_TC004", "Send new message from Teacher to the Student with the Spørsmål enabled and Svar pa optioned is enabled");
		...
		try {
			...
			if (expected_result.equals(actual_result)) {
				...
				test.pass("Verification Completed",
						...
						build());
				test.log(Status.PASS, "Sending new message from Teacher to the Student with the Spørsmål enabled and Svar pa optioned is enabled is successful");
				...
				test.log(Status.FAIL, "Sending new message from Teacher to the Student with the Spørsmål enabled and Svar pa optioned is enabled is failed in verification");
