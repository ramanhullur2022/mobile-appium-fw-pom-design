...
public class TC_UDEMA_1990_TC001_PROD extends Base_Class {
	...
	public void send_reply_from_teacher_to_student() throws Exception {
		...
		try {
			...
			test = extent.createTest("UDEMA_1990_TC001_FAT", "Send Reply from Teacher to Student");

			// Login as Student
			statusLog = "Elev App Login";
			ElevLoginTest elav_login = new ElevLoginTest();
			//elav_login._loginAsStudentInFAT();
			elav_login.loginAsGeneric("student", "prod");
			...
			*/
			...
			page.searchForUserAndSelect(driver2, "teacher", "prod", "na");
			...
			//elev_login_teacher._loginAsTeacherIngvildWithExistingSession();
			...
			//elev_login_student._loginAsStudentRacgaWithExistingSession();
