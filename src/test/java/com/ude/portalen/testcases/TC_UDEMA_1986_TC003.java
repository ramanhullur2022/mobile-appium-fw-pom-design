...
public class TC_UDEMA_1986_TC003 extends Base_Class {
	...
	public void send_Receive_New_Message_with_Svar_Av() throws InterruptedException, Exception {
		...
		try {
			...
			elav_login.loginAsGeneric("teacherOneSchool", "test");
...
//			test.log(Status.PASS, "Klikk på Søkt elev");
			...
			page.searchForUserAndSelect(driver2, "studentOneSchool", "test", "eleven_and_foresatte");
