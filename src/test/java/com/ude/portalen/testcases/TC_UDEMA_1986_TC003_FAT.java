...
public class TC_UDEMA_1986_TC003_FAT extends Base_Class {
	...
	public void send_Receive_New_Message_with_Svar_Av() throws InterruptedException, Exception {
		...
		try {
			...
			elav_login.loginAsGeneric("teacherOneSchool", "fat");
...
//			test.log(Status.PASS, "Klikk på Søkt elev");
			...
			page.searchForUserAndSelect(driver2, "studentOneSchool", "fat", "eleven_and_foresatte");
