...
public class TC_UDEMA_1989_TC001_PROD extends Base_Class {
	...
	public void login_As_Student() throws Exception {
		...
		try {
			...
			test.log(Status.PASS, "Starting Login of "+config.get_fat_student_username());
			ElevLoginTest elav_login = new ElevLoginTest();
			//elav_login._loginAsStudentInFAT();
			elav_login.loginAsGeneric("student", "prod");
			test.log(Status.PASS, config.get_fat_student_username()+" logged in successfully in elev app");
