...
public class TC_UDEMA_1988_FAT extends Base_Class {
	...
	public void teacher_Receive_Push_Notification() throws InterruptedException, Exception {
		...
		try {
			...
			BrowserStudentLogin  portalen_browser = new BrowserStudentLogin("student_username_fat_dynamic", "student_username_fat_dynamic");
			...
			elav_login2._loginAsTeacherInFAT();
