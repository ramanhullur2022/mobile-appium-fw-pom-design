...
public class TC_UDEMA_1984_TC003 extends Base_Class{
	...
	public void send_Receive_New_Message_with_Spørsmål() throws InterruptedException, Exception {
		...
		try {
			...
			test = extent.createTest("UDEMA_1984_TC003", "Send new message to Teacher with the option Spørsmål");
