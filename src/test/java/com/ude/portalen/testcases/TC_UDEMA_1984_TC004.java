...
public class TC_UDEMA_1984_TC004 extends Base_Class{
	...
	@Test
	public void send_Receive_New_SMS_melding() throws InterruptedException, Exception {
		...
		try {
			...
			test = extent.createTest("UDEMA_1984_TC004", "Teacher sends new SMS melding/SMS message to Student");
